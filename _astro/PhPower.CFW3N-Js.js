import{n as c,Y as g,t as r,p as d,O as p,s as u}from"./property.DG_zVZHr.js";var C=Object.defineProperty,v=Object.getOwnPropertyDescriptor,o=(a,i,h,s)=>{for(var e=s>1?void 0:s?v(i,h):i,l=a.length-1,n;l>=0;l--)(n=a[l])&&(e=(s?n(i,h,e):n(e))||e);return s&&e&&C(i,h,e),e};let t=class extends c{constructor(){super(...arguments),this.size="1em",this.weight="regular",this.color="currentColor",this.mirrored=!1}render(){var a;return g`<svg
