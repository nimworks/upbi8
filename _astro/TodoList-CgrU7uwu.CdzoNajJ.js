import{dr as o,d6 as t}from"./app.Dbs6V_q1.js";import{t as s}from"./index.Crn7-fJZ.js";import{c as a}from"./createLucideIcon.RSj0tFkk.js";import{C as c}from"./check.BWO2M5QN.js";/**
 * @license lucide-react v0.554.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const l=[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]],d=a("x",l),m=o.div`
  display: flex;
...
`;const g=({children:i,variant:r="default",icon:e})=>{let n=()=>{switch(r){case"success":return"var(--privy-color-icon-success)";case"error":return"var(--privy-color-icon-error)";default:return"var(--privy-color-icon-muted)"}};return t.jsxs(u,{children:[t.jsx(p,{$variant:r,"data-variant":r,children:(()=>{if(e)return s.isValidElement(e)?s.cloneElement(e,{stroke:n(),strokeWidth:2}):e;switch(r){case"success":default:return t.jsx(c,{size:12,stroke:n(),strokeWidth:3});case"error":return t.jsx(d,{size:12,stroke:n(),strokeWidth:3})}})()}),i]})};let p=o.div`
  display: flex;
  align-items: center;
